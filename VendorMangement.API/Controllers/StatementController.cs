...
namespace VendorMangement.API.Controllers
{
    public class StatementController : ApiController
    {
        ...
        {
            ErrorOr<IEnumerable<ResourceDictionary>> getDictionaryResult = _statementService.GetDictionary();
        ...
        {
            ErrorOr<StatementResponseRoot> getAllStatementMethodResult = _statementService.GetAll(partnerId, contractId, pageNo, pageSize, sortCol, sortType, filterKey);
